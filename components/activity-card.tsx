...
export function ActivityCard() {
  ...
  return (
    <div className="container mx-auto bg-secondary-light pt-5 pb-3 px-4 rounded-t-3xl md:pr-1.5 md:rounded-l-3xl md:pb-5 md:rounded-tr-none">
        <div className="space-y-8">
            <div className="grid gap-6">
              <Card className="bg-[url('/images/recent_bg2.png')] bg-cover h-auto rounded-t-2xl shadow-none p-4 rounded-b-lg md:rounded-l-2xl md:rounded-r-lg">
